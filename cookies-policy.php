...
})(window,document,'script','dataLayer','GTM-K38GN942');</script>
...
<title>Raheja Prime Two Juinagar | Price, Floor Plans, Amenities | Download Brochure</title>
<meta name="description" content="Raheja Prime Two Juinagar - Commercial Project By Raheja Universal Offering Fully Air-Conditioned Retail and Office Spaces. Get A Free Quote Today. See Price List, Amenities, Images, Brochure &amp; Other Details.">
<link rel="canonical" href="https://www.rahejasprimetwo.com">
...
<link rel="preload" as="image" href="./assets/img/deskb1.webp" media="(min-width: 769px)" fetchpriority="high" imagesrcset="./assets/img/deskb1.webp">

<link rel="preload" as="image" href="./assets/img/mob1.webp" media="(max-width: 768px)" fetchpriority="high" imagesrcset="./assets/img/mob1.webp">

<!-- Main CSS -->
<link rel="preload" href="./assets/css/pure_style.css" as="style">
<link rel="stylesheet" href="./assets/css/pure_style.css">

<!-- Chat CSS (NON-BLOCKING) -->
<link rel="stylesheet" href="./assets/css/chatv25.css" media="print" onload="this.media='all'">

<style>
:root{
  --colorPrimary:#358b5f;
  --colorSecondary:#0878bf;
  --colorBtn:#ffffff;

  /* restored from old CSS */
  --bgDesk:url('../img/deskb1.webp');
  --bgMob:url('../img/mob1.webp');
}
...
/* Loader animation (kept optional) */
@keyframes loader{
...
@media (max-width:768px){
  .download-brochure .mob_brochure img{
    ...
    z-index:999;
        ...
        <link rel="stylesheet" href="./assets/css/chatv26.css">

<!-- Small Chatbot -->
</head><body data-spy="scroll" data-target="#navbarNav"><div class="chat-pop-sm">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K38GN942"
...
<!-- End Google Tag Manager (noscript) -->
      ...
      <header class="micro-nav fixed-top pload">
            <nav class="navbar navbar-expand-lg navbar-light bg-white micro-navbar">
                <a class="navbar-brand" href="/"><img alt="Raheja Prime Two Juinagar Logo" src="./assets/img/logo.svg" class="logo"></a>
...
A cookie is a piece of software code that an internet web site sends to your browser when you access information at that site. A cookie is stored as a simple text file on your computer or mobile device by a website’s server and only that server will be able to retrieve or read the contents of that cookie. Cookies let you navigate between pages efficiently as they store your preferences, and generally improve your experience of a website. <a href="/">https://www.rahejasprimetwo.com</a> use following types of cookies to enhance your experience and interactivity :
<br><br>
...
<br><br>
You may note additionally that when you visit <a href="/">https://www.rahejasprimetwo.com</a>, you may be required to accept cookies. If you choose to have your browser refuse cookies, it is possible that <a href="/">https://www.rahejasprimetwo.com</a> may not function properly.

<br><br><br><p style="text-align:center; padding-bottom:20px;">Copyright &copy; 2026 | <a aria-label="About Terms & Conditions" href="terms-conditions.php">Terms & Conditions</a> | <a aria-label="About Privacy Policy" href="privacy-policy.php">Privacy Policy</a> | <a aria-label="About Cookies Policy" href="cookies-policy.php">Cookies Policy</a> | <a aria-label="Go to Home" href="index.html">Home</a></p>
</div>
</section>
...
@media (min-width: 320px) and (max-width: 767px)  {
            ...
            <div class="micro-side text-center">
                <div class="og-section pb-2">
                    <ul class="nav nav-fill og-block">
                        ...
                        <li class="nav-item driftc d-flex-center-items"> <a href="tel:+912246180880" class="textcolor d-flex-center-items"><i class="mi mi-call"></i> +912246180880</a></li>   
                    </ul>
                    <button class="btn-danger pulse-shadow btn btn-sm btn-info micro-form-btn-sm effectScale enqModal mt-1" data-form="sm" data-title="Instant Call Back" data-btn="Request Call Now" data-enquiry="Request Call Back" data-toggle="modal" data-target="#enqModal">
                ...
                <form action="https://microsite.fanmrealty.com/live/lead-callback-v25.php" method="post" class="form-side" id="pardotForm">
                    ...
                    <input type="hidden" id="builder" name="builder" value="Raheja Universal">
                    <input type="hidden" id="project" name="project" value="Raheja Prime One">
                    <input type="hidden" id="lead_source" name="lead_source" value="Microsite">
                    <input type="hidden" name="ip" id="ip" value="43.255.220.7">
                    ...
                    <input type="hidden" name="home_url" value="https://www.rahejasprimetwo.com/cookies-policy.php">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div class="d-flex">
                                <div class="flex-fill align-self-center flex-shrink-1 modal-highlight-bg d-none d-lg-block popbox-left">
                                    <div class="poplogo-box"><span class="popup-logo"><img alt="Raheja Prime Two Juinagar  Logo" src="./assets/img/logo.svg" class="poplogo"></span></div>
                                ...
                                <div class="flex-fill popbox-right">
                                    <div class="modal-head d-none"><span class="modal-title"> Download Brochure</span></div>
                                    <div class="poplogo-box desktop"><span class="popup-logo"><img alt="Raheja Prime Two Juinagar  Logo" src="./assets/img/logo.svg" class="poplogo logo"></span></div>
    ...
    <!--CONTACT NO-->
            <a href="tel:+912246180880" aria-label="Contact No." class="popcallbtn modal-call-btn d-block" style="padding: 0.5rem 1rem;"><i class="mi mi-call"></i> +912246180880</a>
...
<!--DOWNLOAD BROCHURE BUTTON START-->
            <div class="download-brochure">
                <div class="desk_brochure">
                    <a class="enqModal" href="#" data-form="md" data-title="Download brochure" data-btn="Download now" data-enquiry="Download Brochure Sticky Desktop" data-redirect="brochure" data-redirect-file="brochure.pdf" data-toggle="modal" data-target="#enqModal">
                        <img src="./assets/img/brochure_icon_n1.webp" alt="Download brochure" width="48" height="48" loading="lazy" decoding="async" style="max-width:100%;height:auto;">

                    </a>
                </div>
                <div class="mob_brochure">
                    <a class="enqModal" href="#" data-form="md" data-title="Download brochure" data-btn="Download now" data-enquiry="Download Brochure Sticky Mobile" data-redirect="brochure" data-redirect-file="brochure.pdf" data-toggle="modal" data-target="#enqModal">
                        <img src="./assets/img/brochure_icon_mob_n1.webp" alt="Download brochure" width="83" height="252" loading="lazy" decoding="async" style="max-width:100%;height:auto;">
                    </a>
                </div>
            </div>
         <!--COOKIES CODE START-->
       ...
       <!-- Start of Async Drift Code --> 
        <script defer="defer">
            var executed = true;
            var h1tag = "Raheja Prime Two Juinagar";
        ...
        <div class="col-md-4"><button class="btn btn-info micro-form-btn enqModal effetMoveGradient effectScale float-lg-right mx-sm-auto  d-none d-lg-block" data-form="lg" data-title="Get Directions" data-btn="Send Now" data-enquiry="Get Directions" data-redirect="floorplan" data-toggle="modal" data-target="#enqModal">Get Directions</button></div></div>
                    <div class="row mb-3"> 
                        ...
                        <div class="row"> 
                        <div class="col loc-pointer loc-pointer-first"><div class="loc-text"><i class="mi mi-loc-list-2 color-primary loc-icon"></i> <span>Thane Belapur Road </span> </div><span class="text-right">3 mins</span></div> 
                        <div class="col loc-pointer"><div class="loc-text"><i class="mi mi-loc-list-2 color-primary loc-icon"></i> <span>Juinagar Railway Station </span></div> <span class="text-right">10 mins</span></div> 
                        <div class="col loc-pointer"><div class="loc-text"><i class="mi mi-loc-list-2 color-primary loc-icon"></i> <span>Navi Mumbai International Airport </span> </div><span class="text-right">18 mins</span></div> 
                    </div> 
                        </div>
                    </div> 
...
<script src="./assets/js/commercialchatv25.js" defer=""></script>

<script type="text/javascript">
    var chatbotApiInput = {
        home_url: "https://www.rahejasprimetwo.com/cookies-policy.php",
        gclid: "",
        utm_source: "",
        utm_medium: "",
        utm_campaign: "",
...
function bindFormSubmit() {
  ...
  let fpPromise = null; // lazy initialized
  ...
  $('form#pardotForm').off('submit').on('submit', function (e) {
    ...
    const $errorSpan = $form.find('.errorMessage');
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (!fpPromise) {
          fpPromise = import('https://fpjscdn.net/v3/rmevazJvk6HdBPJpRXuX')
        ...
        fpPromise
          .then(fp => fp.get())
          .then(result => {
            submitWithDeviceId(result.visitorId);
          })
          .catch(err => {
            console.error('FingerprintJS error:', err);
            submitWithDeviceId('fallback-' + Date.now());
          });
      },
    ...
    function submitWithDeviceId(deviceId) {
      let $deviceIdField = $form.find('input[name="device_id"]');

      if ($deviceIdField.length === 0) {
        $form.append('<input type="hidden" name="device_id">');
...
(function () {
  ...
  { code: "BA", name: "Bosnia and Herzegowina", dial: "387" },
  ...
  { code: "CG", name: "Congo Democratic Republic of", dial: "242" },
  ...
  { code: "FK", name: "Falkland Islands (Malvinas)", dial: "500" },
  ...
  { code: "HM", name: "Heard Island and McDonald Islands", dial: "011" },
  ...
  { code: "IR", name: "Iran (Islamic Republic of)", dial: "98" },
  ...
  { code: "KP", name: "Korea, Democratic People's Republic of", dial: "850" },
  ...
  { code: "SJ", name: "Svalbard and Jan Mayen Islands", dial: "47" },
  ...
  { code: "UM", name: "United States Minor Outlying Islands", dial: "246" },
  { code: "UY", name: "Uruguay", dial: "598" },
  { code: "UZ", name: "Uzbekistan", dial: "998" },
  { code: "VU", name: "Vanuatu", dial: "678" },
  { code: "VA", name: "Vatican City State", dial: "379" },
  { code: "VE", name: "Venezuela", dial: "58" },
  { code: "VN", name: "Vietnam", dial: "84" },
  { code: "VG", name: "Virgin Islands (British)", dial: "1-284" },
  { code: "VI", name: "Virgin Islands (U.S.)", dial: "1-340" },
  { code: "WF", name: "Wallis and Futuna Islands", dial: "681" },
  { code: "EH", name: "Western Sahara", dial: "212" },
  { code: "YE", name: "Yemen", dial: "967" },
  { code: "RS", name: "Serbia", dial: "381" },
  { code: "ZM", name: "Zambia", dial: "260" },
  { code: "ZW", name: "Zimbabwe", dial: "263" },
  { code: "AX", name: "Aaland Islands", dial: "358" },
  ...
  { code: "CW", name: "Cura�ao", dial: "599" },
  { code: "CI", name: "Ivory Coast", dial: "225" },
  { code: "XK", name: "Kosovo", dial: "383" }
];

    document.querySelectorAll('.my_country_name').forEach(select => {

      if (select.dataset.loaded === "true") return;
      select.dataset.loaded = "true";

      // Collect existing option values (avoid duplicates)
      const existingValues = new Set(
        Array.from(select.options).map(o => o.value.trim())
      );

      countries.forEach(c => {
        if (existingValues.has(c.name)) return; // 🔒 skip existing 5

        const opt = document.createElement("option");
        opt.value = c.name;
        opt.textContent = `${c.name} (+${c.dial})`;
        opt.setAttribute("data-countrycode", c.code);
        opt.setAttribute("data-contry_code", c.dial);
