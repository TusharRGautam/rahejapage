    ...
    <!--exit modal 2 end -->
            <div class="micro-side text-center">
                ...
                <form action="https://microsite.fanmrealty.com/live/lead-callback-v25.php" method="post" class="form-side" id="pardotForm">
                    ...
                    <input type="hidden" name="home_url" value="https://www.rahejasprimetwo.com/privacy-policy.php">
...
<script type="text/javascript">
    var chatbotApiInput = {
        home_url: "https://www.rahejasprimetwo.com/privacy-policy.php",
        gclid: "",
        utm_source: "",
        utm_medium: "",
        utm_campaign: "",
